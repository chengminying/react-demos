...
class Animation extends React.Component {
  ...
  render() {
    return (
      <div style={{ position: 'relative', height: 200, width: 200, margin: 'auto', marginTop: '50px' }}>
        <TweenOne
          animation={this.animation}
          style={{ margin: 0, width: 20,backgroundColor: "rgb(1, 155, 240)",borderRadius: '4px', height: 20, transform: 'translate(-10px, -10px)' }}
          className="code-box-shape"
          paused={this.props.paused}
          reverse={this.props.reverse}  
        />
        <svg width="200" height="200" style={{position: "absolute", top: 0}}>
